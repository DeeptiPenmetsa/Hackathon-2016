...
<nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0; background-color: tomato !important; color: white;">
    ...
    <asp:Panel ID="loginPanel" runat="server">
        ...
        <div class="row">
            ...
            <div class="navbar-form-custom col-md-offset-2 col-md-8" style="width: 400px; padding-top: 5px;">
                <span class="clear"><span class="block m-t-xs" style="color: white;"><strong class="font-bold" style="font-weight: 500; font-size: x-large; word-wrap: normal;">Hackathon</strong></span></span>
            </div>

            <div id="Div1" runat="server" class="pull-right col-md-offset-10 col-md-2">
                <a href="#" runat="server" id="A1" class="margin btn btn-primary" onclick="userLogin()">Login here !</a>
            </div>
        </div>
