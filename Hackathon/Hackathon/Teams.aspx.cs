...
public partial class Default2 : System.Web.UI.Page
{
            ...
            if (dtTeams != null)
            {
                foreach (DataRow dr in dtTeams.Rows)
                {
                    ...
                    group.Append("<td style='text-align: left'> " +
                            ...
                            "<a href='#' onClick='ViewReviews(" + dr["TeamId"].ToString() + ",\"" + dr["TeamName"].ToString() + "\")'>View Reviews</a></td>");
    ...
    public static string getReviews()
    {
        ...
        if (dtComments != null)
        {
            ...
            {
                sb += "<div class='ibox-content'><div class='table-responsive'><div>";
                sb += "<div class='row'><h3>" + dr["LastName"].ToString() + "</h3></div>";
                sb += "<div class='row'><p><div>Comment</div><div>" + dr["Comments"].ToString() + "</div></p></div>";
                sb += "</div></div></div>";
            }
            return sb;
        }
